...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ world;
USE world;

--
-- Table structure for table `world`.`city`
--
...
--
-- Dumping data for table `world`.`city`
--
...
--
-- Table structure for table `world`.`country`
--
...
--
-- Dumping data for table `world`.`country`
--
...
--
-- Table structure for table `world`.`countrylanguage`
--
...
--
-- Dumping data for table `world`.`countrylanguage`
--
